...
[![Codecov](https://img.shields.io/codecov/c/github/gorango/flowcraft/master?flag=adapter-kafka)](https://codecov.io/github/gorango/flowcraft/tree/master/packages/adapter-kafka/src?flags[0]=adapter-kafka)
